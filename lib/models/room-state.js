...
class RoomState extends _typedEventEmitter.TypedEventEmitter {
  ...
  processBeaconEvents(events) {
    ...
    const locationEventsByBeaconEventId = events.reduce((acc, event) => {
      var _event$getRelation;

      const beaconInfoEventId = (_event$getRelation = event.getRelation()) === null || _event$getRelation === void 0 ? void 0 : _event$getRelation.event_id;
