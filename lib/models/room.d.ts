...
export declare class Room extends TypedEventEmitter<EmittedEvents, RoomEventHandlerMap> {
    ...
    createThreadFetchRoot(threadId: string, events?: MatrixEvent[], toStartOfTimeline?: boolean): Promise<Thread | null>;
    private addThreadedEvents;
    /**
     * Adds events to a thread's timeline. Will fire "Thread.update"
     * @experimental
     */
    processThreadedEvents(events: MatrixEvent[], toStartOfTimeline: boolean): Promise<unknown>;
